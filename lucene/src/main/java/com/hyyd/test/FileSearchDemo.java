package com.hyyd.test;

import com.hyyd.test.util.FileUtil;
...
{
	public static final String INDEX_PATH = "D:\\workspace\\data\\lucene"; // 存放Lucene索引文件的位置
	public static final String SCAN_PATH = "D:\\workspace\\data\\text"; // 需要被扫描的位置，测试的时候记得多在这下面放一些文件
