...
//   }
  ...
  public static void main(String[] args) {
    File file = new File("C:\\Users\\hyyd\\Desktop\\0思维图-20190426");


    Collection<File> mmap = FileUtils.listFiles(file, new String[]{"mmap","xsvd"}, true);
    mmap.forEach(System.out::println);
