...
//        System.out.println("======================================");
        ...
        compareStr("黔文律师事务所", "贵州黔文律师事务所");
        compareStr("北京市丰和律师事务", "北京市丰禾律师事务");
        compareStr("河北陈建中律师事务所", "河南省三友律师事务所");

        compareStr("河北陈建中律师事务所", "河北精忠律师事务所");

        compareStr("北京市方元律师事务所", "北京市方桥律师事务所");
        compareStr("北京市方元律师事务所", "北京市方正律师事务所");
        compareStr("北京市方元律师事务所", "北京市方略律师事务所");
        compareStr("北京市方元律师事务所", "北京市方禾律师事务所");
        compareStr("北京市方元律师事务所", "北京市方舟律师事务所");
        compareStr("北京市方元律师事务所", "北京市方诚律师事务所");
        compareStr("北京市方元律师事务所", "北京市方谷律师事务所");

        compareStr("北京市昊方律师事务所", "北京市昊明律师事务所");
        compareStr("河北精忠律师事务所", "河南精忠律师事务所");

        compareStr("北京市方元律师事务所", "北京市方源律师事务所");
        compareStr("北京市方元律师事务所", "北京市方园律师事务所");
        compareStr("北京市方原律师事务所", "北京市方源律师事务所");
        compareStr("北京市方钟律师事务所", "北京市方种律师事务所");
...
//                北京市昊明律师事务所
    ...
    public static void compareStr(String s1, String s2) {
        MySimHash mySimHash1 = new MySimHash(s1);
        MySimHash mySimHash2 = new MySimHash(s2);
        System.out.println("======================================");
        System.out.println(s1 + "=="+ s2 +" : " + mySimHash1.hammingDistance(mySimHash2) + "  " + mySimHash1.getSemblance(mySimHash2));
        System.out.println("======================================");
    }
}
