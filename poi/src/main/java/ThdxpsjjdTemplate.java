    ...
    public void init(Document templateDoc, Object object) {
        ...
        xwpf.getBodyElements().forEach((IBodyElement iBodyElement) -> {
            ...
            if (iBodyElement.getElementType().equals(BodyElementType.PARAGRAPH)) {
                ...
                if (hasDealTable) {
//                    Attribute attr = (Attribute) XmlUtil.getSingleNode(templateDoc, "/writ/QW/WW[@value]");
//                    Attribute attrO = (Attribute) XmlUtil.getSingleNode(templateDoc, "/writ/QW/WW[@oValue]");
...
//                    Attribute attr = (Attribute) XmlUtil.getSingleNode(templateDoc, "/writ/QW/WS[@value]");
//                    Attribute attrO = (Attribute) XmlUtil.getSingleNode(templateDoc, "/writ/QW/WS[@oValue]");
